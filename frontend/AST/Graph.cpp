...
string getNodeName(ast_node * astnode)
{
    ...
    switch (astnode->node_type) {
        ...
        case ast_operator_type::AST_OP_ASSIGN:
            nodeName = "=";
            break;
        case ast_operator_type::AST_VAR_CONST_DECL:
            nodeName = "Const";
            break;
        case ast_operator_type::AST_VAR_CONST_DEF:
            nodeName = "Define";
            break;
        case ast_operator_type::AST_VAR_VAR_DECL:
            nodeName = "Varible";
            break;
        case ast_operator_type::AST_VAR_VAR_DEF:
            nodeName = "Defines";
            break;
        case ast_operator_type::AST_COND:
            nodeName = "Condition";
            break;
        case ast_operator_type::AST_ELSE:
            nodeName = "Else";
            break;
        case ast_operator_type::AST_WHILE:
            nodeName = "while";
            break;
        case ast_operator_type::AST_BREAK:
            nodeName = "Break";
            break;
        case ast_operator_type::AST_CONTINUE:
            nodeName = "Continue";
            break;
        case ast_operator_type::AST_TYPE_INT:
            nodeName = "int";
            break;
        case ast_operator_type::AST_TYPE_VOID:
            nodeName = "void";
            break;
        case ast_operator_type::AST_RETURN_TYPE:
            nodeName = "Return type";
            break;
        case ast_operator_type::AST_PARAM:
            nodeName = "Parameter";
            break;
        ...
        case ast_operator_type::AST_ARRAY:
            nodeName = "Array";
            break;
        case ast_operator_type::AST_ARRAY_INIT_VAL:
            nodeName = "Arrary Init Val";
            break;
        case ast_operator_type::AST_ARRAY_INIT_VAL_LIST:
            nodeName = "Arrary Init Val List";
            break;
        case ast_operator_type::AST_EXP_LIST:
            nodeName = "Exp list";
            break;
        case ast_operator_type::AST_CONST_EXP_LIST:
            nodeName = "Const Exp list";
            break;
        case ast_operator_type::AST_CONST_ARRAY_INIT_VAL_LIST:
            nodeName = "Const Arrary Init Val List";
            break;
        case ast_operator_type::AST_CONST_ARRAY_INIT_VAL:
            nodeName = "Const Arrary Init Val";
            break;
